# Introducción
En este laboratorio práctico nos familiarizaremos con Unity Catalog, una herramienta de gobernanza de datos de nueva generación. A través de un ejercicio guiado, aprenderemos a desplegar, configurar y utilizar esta solución open source que permite organizar, compartir y controlar el acceso a datos y productos de datos como tablas, volúmenes, funciones o modelos de machine learning.

En un momento donde la compartición de datos se ha vuelto esencial para el avance de la analítica y la colaboración entre organizaciones, Unity Catalog ofrece una forma estructurada y segura de gestionar estos recursos. Su capacidad para centralizar metadatos, aplicar políticas de acceso y garantizar trazabilidad lo convierten en una pieza clave para habilitar ecosistemas de datos más abiertos, reutilizables y auditables.
