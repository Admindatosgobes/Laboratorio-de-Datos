...
# === SEASONAL MULTIPLIERS (E4/E5) ===
MEDITERRANEAN_ROADS = ['AP-7', 'A-7', 'A-7S', 'AP-7N', 'A-7N']  # Mediterranean corridor
ATLANTIC_ROADS = ['A-8', 'AP-9', 'AP-9N', 'A-8S']               # Cantabrian/Atlantic corridor

SEASONAL_MULTIPLIERS = {
    'default': 1.0,
    'mediterranean_shoulder': 2.0,  # AP-7, A-7: June/September (E4)
    'mediterranean_peak': 2.5,      # AP-7, A-7: July/August peak (E4)
    'atlantic_peak': 1.5,           # A-8, AP-9: July/August (E5)
...
# === OUTPUT FILE NAMES ===
OUTPUT_FILE_1 = 'File_1.csv'  # Global Network KPIs (1 row)
OUTPUT_FILE_2 = 'File_2.csv'  # Proposed Charging Locations
OUTPUT_FILE_3 = 'File_3.csv'  # Friction Points (Moderate + Congested only)

# === OUTPUT SCHEMAS (exact column names required by datathon brief) ===
FILE_1_COLUMNS = [
